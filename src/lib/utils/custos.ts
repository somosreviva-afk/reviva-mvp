...
export function calcularCustosPedido(
  ...
  if (qtdImas <= 0) {
    return { qtd_imas: 0, custo_imas: 0, custo_saquinhos: 0, custo_caixa: 0, custo_envelope: 0, custo_papel_seda: 0, custo_cartao: 0, custo_adesivo_caixa: 0, custo_lacre_caixa: 0, custo_total_pedido: 0 }
  }
  ...
  const custo_total_pedido = r2(
    custo_imas + custo_saquinhos + custo_caixa + custo_envelope +
    custo_papel_seda + custo_cartao + custo_adesivo_caixa + custo_lacre_caixa
  )
  return { qtd_imas: qtdImas, custo_imas, custo_saquinhos, custo_caixa, custo_envelope, custo_papel_seda, custo_cartao, custo_adesivo_caixa, custo_lacre_caixa, custo_total_pedido }
}
