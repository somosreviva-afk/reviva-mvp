...
const CATEGORIAS = ['Venda de produto', 'Serviço', 'Pedido recebido', 'Outros']
  ...
  return (
    <div className="p-4">
      <div className="flex items-center gap-3 pt-4 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Nova Entrada</h1>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="Ex: Venda pedido #42"
        ...
        <div>
          ...
          <input
            ...
            step="0.01"
            min="0"
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-lg font-bold"
          />
        </div>
