...
const CONFIG_CAMPOS = [
  ...
  { chave: 'telefone_empresa', label: 'Telefone para documentos', tipo: 'tel', placeholder: '(11) 99999-9999' },
  { chave: 'instagram_empresa', label: 'Instagram', tipo: 'text', placeholder: '@seuperfil' },
  { chave: 'pix_empresa', label: 'Chave PIX', tipo: 'text', placeholder: 'CPF, CNPJ, email ou telefone' },
  { chave: 'custo_fotoimagas_por_convidado', label: 'Custo fotoímã por convidado (R$)', tipo: 'number', placeholder: '1.75' },
    ...
    <div className="p-4 space-y-5 pb-10">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 space-y-3">
        <h2 className="font-semibold text-gray-800 text-sm flex items-center gap-2">
          ...
          Dados da empresa & Parâmetros
        </h2>
        {CONFIG_CAMPOS.map(({ chave, label, tipo, placeholder }) => (
          <div key={chave}>
